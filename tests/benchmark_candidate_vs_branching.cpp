...
int main(
    ...
    try {
        ...
        if (reference.size() < primer_length) {
            throw std::runtime_error(
                "Reference is shorter than primer."
            );
        }
         ...
         * the source string is moved into BiFM.
         */
